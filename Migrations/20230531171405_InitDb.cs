    ...
    public partial class InitDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TypeOfCuisines", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MenuImages_Restaurants_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RestaurantCuisines_TypeOfCuisines_TypeOfCuisineId",
                        column: x => x.TypeOfCuisineId,
                        principalTable: "TypeOfCuisines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "RestaurantExtraServices",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestaurantExtraServices", x => new { x.RestaurantId, x.ExtraServiceId });
                    table.ForeignKey(
                        name: "FK_RestaurantExtraServices_ExtraServices_ExtraServiceId",
                        column: x => x.ExtraServiceId,
                        principalTable: "ExtraServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RestaurantExtraServices_Restaurants_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RestaurantServices_TypeOfServices_TypeOfServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    RestaurantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SuitabilityId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestaurantSuitabilities", x => new { x.RestaurantId, x.SuitabilityId });
                    table.ForeignKey(
                        name: "FK_RestaurantSuitabilities_Restaurants_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RestaurantSuitabilities_Suitabilities_SuitabilityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuImages_RestaurantId",
                table: "MenuImages",
                column: "RestaurantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RestaurantServices_TypeOfServiceId",
                table: "RestaurantServices",
                column: "TypeOfServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_RestaurantSuitabilities_SuitabilityId",
                table: "RestaurantSuitabilities",
